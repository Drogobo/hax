...
title_2.Position = UDim2.new(0.00930820499, 0, -0.00312500005, 0)
title_2.Size = UDim2.new(0, 11, 0, 25)
...
title_3.BackgroundColor3 = Color3.fromRGB(255, 170, 0)
title_3.BackgroundTransparency = 1.000
title_3.Position = UDim2.new(0.023822004, 0, -0.00312500005, 0)
title_3.Size = UDim2.new(0, 17, 0, 14)
title_3.Font = Enum.Font.Arial
title_3.Text = "X"
title_3.TextColor3 = Color3.fromRGB(255, 102, 0)
title_3.TextSize = 10.000

scripthub_2.Name = "scripthub"
scripthub_2.Parent = SynapseX
...
title_4.BackgroundColor3 = Color3.fromRGB(255, 170, 0)
title_4.BackgroundTransparency = 1.000
title_4.Position = UDim2.new(0.0265495852, 0, -0.00312500005, 0)
title_4.Size = UDim2.new(0, 11, 0, 25)
...
title_5.Name = "title"
title_5.Parent = scripthub_2
title_5.BackgroundColor3 = Color3.fromRGB(255, 170, 0)
title_5.BackgroundTransparency = 1.000
title_5.Position = UDim2.new(0.061753042, 0, -0.00312500005, 0)
title_5.Size = UDim2.new(0, 17, 0, 14)
title_5.Font = Enum.Font.Arial
title_5.Text = "X"
title_5.TextColor3 = Color3.fromRGB(255, 102, 0)
...
title_6.Name = "title"
title_6.Parent = scripthub_2
title_6.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
title_6.BackgroundTransparency = 1.000
title_6.Position = UDim2.new(0.161097407, 0, -0.000307376496, 0)
title_6.Size = UDim2.new(0, 200, 0, 22)
title_6.Font = Enum.Font.SourceSans
title_6.Text = "Synapse X - Script Hub"
...
local function RVHUK_fake_script() -- Close.LocalScript 
...
coroutine.wrap(RVHUK_fake_script)()
local function OOGRM_fake_script() -- ImageLabel.LocalScript 
...
coroutine.wrap(OOGRM_fake_script)()
local function LIMJDQ_fake_script() -- execute.LocalScript 
	local script = Instance.new('LocalScript', execute)

	wait()
	local loadstring = script.Parent.Parent.Parent.Remote
	
	script.Parent.MouseButton1Click:Connect(function()
		if script.Parent.Parent.check.Value == true then
			loadstring:FireServer(script.Parent.Parent.ImageLabel.EditorFrame.Source.Text)
		end
		if script.Parent.Parent.check.Value == false then
			script.Parent.Parent.title.Text = "Synapse X - vRBX (not injected! press attach before executing)"
			wait(1)
			script.Parent.Parent.title.Text = "Synapse X - vRBX"
		end
	end)
end
coroutine.wrap(LIMJDQ_fake_script)()
local function ZDXD_fake_script() -- clear.LocalScript 
	local script = Instance.new('LocalScript', clear)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.ImageLabel["script box"].Text = ""
	end)
end
coroutine.wrap(ZDXD_fake_script)()
local function PZJNNOH_fake_script() -- scripthub.LocalScript 
...
coroutine.wrap(PZJNNOH_fake_script)()
local function SOQB_fake_script() -- Attach.LocalScript 
	local script = Instance.new('LocalScript', Attach)

	script.Parent.MouseButton1Click:Connect(function()
		local title = script.Parent.Parent.title
		local check = script.Parent.Parent.check
...
coroutine.wrap(SOQB_fake_script)()
local function DEMYL_fake_script() -- MainFrame.Dragging 
...
coroutine.wrap(DEMYL_fake_script)()
local function UIOZ_fake_script() -- scripthub_2.Dragging 
...
coroutine.wrap(UIOZ_fake_script)()
local function UBBKYEY_fake_script() -- dex.select 
	local script = Instance.new('LocalScript', dex)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.option.Value = "dex"
		script.Parent.BackgroundTransparency = 0
		script.Parent.BorderSizePixel = 1
	end)
end
coroutine.wrap(UBBKYEY_fake_script)()
local function FDIDH_fake_script() -- dex.unselect 
	local script = Instance.new('LocalScript', dex)

	while true do
		wait(0.05)
		if script.Parent.Parent.option.Value ~= "dex" then
			script.Parent.BackgroundTransparency = 1
			script.Parent.BorderSizePixel = 0
		end
	end
end
coroutine.wrap(FDIDH_fake_script)()
local function NPZXLCQ_fake_script() -- esp.unselect 
	local script = Instance.new('LocalScript', esp)

	while true do
		wait(0.05)
		if script.Parent.Parent.option.Value ~= "esp" then
			script.Parent.BackgroundTransparency = 1
			script.Parent.BorderSizePixel = 0
		end
	end
end
coroutine.wrap(NPZXLCQ_fake_script)()
local function UNICTLY_fake_script() -- esp.select 
	local script = Instance.new('LocalScript', esp)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.option.Value = "esp"
		script.Parent.BackgroundTransparency = 0
		script.Parent.BorderSizePixel = 1
	end)
end
coroutine.wrap(UNICTLY_fake_script)()
local function LXASP_fake_script() -- spy.unselect 
	local script = Instance.new('LocalScript', spy)

	while true do
		wait(0.05)
		if script.Parent.Parent.option.Value ~= "spy" then
			script.Parent.BackgroundTransparency = 1
			script.Parent.BorderSizePixel = 0
		end
	end
end
coroutine.wrap(LXASP_fake_script)()
local function AUMWFX_fake_script() -- spy.select 
	local script = Instance.new('LocalScript', spy)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.option.Value = "spy"
		script.Parent.BackgroundTransparency = 0
		script.Parent.BorderSizePixel = 1
	end)
end
coroutine.wrap(AUMWFX_fake_script)()
local function VXNHNX_fake_script() -- dumper.unselect 
	local script = Instance.new('LocalScript', dumper)

	while true do
		wait(0.05)
		if script.Parent.Parent.option.Value ~= "dumper" then
			script.Parent.BackgroundTransparency = 1
			script.Parent.BorderSizePixel = 0
		end
	end
end
coroutine.wrap(VXNHNX_fake_script)()
local function XDYJ_fake_script() -- dumper.select 
	local script = Instance.new('LocalScript', dumper)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.option.Value = "dumper"
		script.Parent.BackgroundTransparency = 0
		script.Parent.BorderSizePixel = 1
	end)
end
coroutine.wrap(XDYJ_fake_script)()
local function HKPL_fake_script() -- descri.LocalScript 
	local script = Instance.new('LocalScript', descri)

	while true do
		if script.Parent.Parent.Visible == true then
			wait(0.03)
			if script.Parent.Parent.Parent.select.option.Value == "dex" then
				script.Parent.Text = "A version of the popular Dex explorer with patches specifically for Synapse X."
			end
			if script.Parent.Parent.Parent.select.option.Value == "esp" then
				script.Parent.Text = "ESP Made by ic3w0lf using the Drawing API."
			end
			if script.Parent.Parent.Parent.select.option.Value == "spy" then
				script.Parent.Text = "Allows you to view RemoteEvents and RemoteFunctions called."
			end
			if script.Parent.Parent.Parent.select.option.Value == "dumper" then
				script.Parent.Text = "Dumps all LocalScripts and ModuleScripts."
			end
		end
	end
end
coroutine.wrap(HKPL_fake_script)()
local function RWROP_fake_script() -- execute_2.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
		if script.Parent.Parent.Parent.MainFrame.check.Value == true then
			if script.Parent.Parent.select.option.Value == "dex" then
				loadstring:FireServer(loadstring(game:HttpGet("https://raw.githubusercontent.com/Neon-Fox/roblox-scripts/main/Dex-V3"))())
			end
			if script.Parent.Parent.select.option.Value == "spy" then
				loadstring:FireServer(loadstring(game:HttpGet("https://pastebin.com/raw/JfXaL0RK"))())
			end
			if script.Parent.Parent.select.option.Value == "dumper" then
				loadstring:FireServer(loadstring(game:HttpGet("https://pastebin.com/raw/BfEHFqzH"))())
			end
			if script.Parent.Parent.select.option.Value == "esp" then
				loadstring:FireServer(loadstring(game:HttpGet("https://raw.githubusercontent.com/ic3w0lf22/Unnamed-ESP/master/UnnamedESP.lua"))())
			end
		end
		if script.Parent.Parent.Parent.MainFrame.check.Value == false then
			script.Parent.Text = "Not Attached!"
			wait(1)
			script.Parent.Text = "Execute"
		end
	end)
end
coroutine.wrap(RWROP_fake_script)()
local function QWLC_fake_script() -- close.LocalScript 
	local script = Instance.new('LocalScript', close)

	script.Parent.MouseButton1Click:Connect(function()
		script.Parent.Parent.Visible = false
		script.Parent.Parent.select.option.Value = "None"
	end)
end
coroutine.wrap(QWLC_fake_script)()
